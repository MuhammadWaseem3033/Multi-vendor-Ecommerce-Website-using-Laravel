                ...
                <div class="row align-items-center u-s-m-x-0">
                    <div class="col-lg-6 col-md-6 col-sm-12 u-s-p-x-0">
                        <div class="newsletter-image">
                            <a target="_blank" rel="nofollow" href="{{url('/')}}" class="banner-hover effect-dark-opacity">
                                <img class="img-fluid" src="{{url('front/images/banners/stack-developers-modal-popup.png')}}" alt="Newsletter Image">
                            </a>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <!-- Product-zoom-area -->
                        <div class="zoom-area">
                            <img id="zoom-pro-quick-view" class="img-fluid" src="{{url('front/images/product/product@4x.jpg')}}" data-zoom-image="{{url('front/images/product/product@4x.jpg')}}" alt="Zoom Image">
                            <div id="gallery-quick-view" class="u-s-m-t-10">
                                <a class="active" data-image="{{url('front/images/product/product@4x.jpg')}}" data-zoom-image="{{url('front/images/product/product@4x.jpg')}}">
                                    <img src="{{url('front/images/product/product@2x.jpg')}}" alt="Product">
                                </a>
                                <a data-image="{{url('front/images/product/product@4x.jpg')}}" data-zoom-image="{{url('front/images/product/product@4x.jpg')}}">
                                    <img src="{{url('front/images/product/product@2x.jpg')}}" alt="Product">
                                </a>
                                <a data-image="{{url('front/images/product/product@4x.jpg')}}" data-zoom-image="{{url('front/images/product/product@4x.jpg')}}">
                                    <img src="{{url('front/images/product/product@2x.jpg')}}" alt="Product">

                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="zoom-area">
                        <img id="zoom-pro" class="img-fluid"
                            src="{{ asset('front/product/image/large/' . $productDetails['product_image']) }}"
                            data-zoom-image="{{ asset('front/product/image/large/' . $productDetails['product_image']) }}"
                            alt="Zoom Image">
                        <div id="gallery" class="u-s-m-t-10">
                            <a class="active"
                                data-image="{{ asset('front/product/image/large/' . $productDetails['product_image']) }}"
                                data-zoom-image="{{ asset('front/product/image/large/' . $productDetails['product_image']) }}">
                                <img src="{{ asset('front/product/image/large/' . $productDetails['product_image']) }}"
                                    alt="Product">
                            </a>
                            @foreach ($productDetails['addimage'] as $image)
                                <a data-image="{{ asset('front/product/image/large/' . $image['image']) }}"
                                    data-zoom-image="{{ asset('front/product/image/large/' . $image['image']) }}">
                                    <img src="{{ asset('front/product/image/large/' . $image['image']) }}" alt="Product">
                                </a>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="all-information-wrapper">
                        @if (session()->has('massage'))
                            <div class="alert alert-success alert-block">
                                ...
                                <strong>Success :<?php echo session()->get('massage')  ; ?></strong>
                            </div>
                        ...
                        <div class="section-1-title-breadcrumb-rating">
                            ...
                            <ul class="bread-crumb">
                                ...
                                <li class="has-separator">
                                    <a href="javascript::0">{{ $productDetails['section']['name'] }}</a>
                                </li>
                        ...
                        <div class="section-3-price-original-discount u-s-p-y-14">
                            <span class="getDiscountAttributePrice">
                        ...
                        <div class="section-4-sku-information u-s-p-y-14">
                            ...
                            <div class="left">
                                <span>Only:</span>
                                <span>{{ $totalstock }} <span style="color: rgb(0, 255, 106)">Left</span></span>
                            </div>
                            @if (isset($productDetails['vendor']))
                                <div class="">
                                    <span>Supplier:</span>
                                    <span>{{ $productDetails['vendor']['name'] }}</span>
                                </div>
                            @endif
                            @if (isset($productDetails['vendor']))
                                <div class="">
                                    <span>Supplier Shop Name : </span>
                                    <span><a href="/products/{{ $productDetails['vendor']['id'] }}">
                                            {{ $productDetails['vendor']['vendor_bussiness_details']['shop_name'] }}</a></span>
                                </div>
                            @endif
                        </div>
                        <form action="{{ route('add.to.cart') }}" method="post" class="post-form">
                            @csrf
                            ...
                            <div class="section-6-social-media-quantity-actions u-s-p-y-14">
                                ...
                                <div class="quantity-wrapper u-s-m-b-22">
                                    <span>Quantity:</span>
                                    <div class="quantity">
                                        <input type="number" class="quantity-text-field" value="1" name="quantity">
                                    </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade active show" id="description">
                                <div class="description-whole-container">
                                    <p class="desc-p u-s-m-b-26">{{ $productDetails['discription'] }}</p>
                                    <div class="row">
                                        <div class="col-9">
                                            @if (isset($productDetails['product_image']))
                                                <img class="desc-img img-fluid u-s-m-b-26"
                                                    src="{{ asset('front/product/image/large/' . $productDetails['product_image']) }}"
                                                    width="210" height="100" alt="Product">
                                            @else
                                                <img class="desc-img img-fluid u-s-m-b-26"
                                                    src="{{ asset('front/product/image/000000.webp') }}" alt="Product">
                                            @endif
                                        </div>
                                        <div class="col-3">
                                            @if (isset($productDetails['discription']))
                                                <video width="250" height="210" controls>
                                                    <source type="vedio/mp4"
                                                        src="{{ asset('front/product/vedio/' . $productDetails['product_vedio']) }}">
                                                </video>
                                            @else
                                                Product vedio Not Found
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table>
                                            @foreach ($productsFilters as $productsFilter)
                                                ...
                                                @if ($filterAvailible == 'Yes')
                                                    <tr>
                                                        <td>{{ $productsFilter['filter_name'] }}</td>
                                                        <td>
                                                            @foreach ($productsFilter['filter_values'] as $value)
                                                                @if (
                                                                    !empty($productDetails[$productsFilter['filter_culumn']]) &&
                                                                        $value['filter_value'] == $productDetails[$productsFilter['filter_culumn']]
                                                                )
                                                                    {{ $value['filter_value'] }}
                                                                @endif
                                                            @endforeach
            ...
            <div class="detail-different-product-section u-s-p-t-80">
                    ...
                    <div class="container">
                        ...
                        <div class="slider-fouc">
                            <div class="products-slider owl-carousel" data-item="4">
                                @foreach ($samilerproduct as $product)
                                    <div class="item">
                                        <div class="image-container">
                                            @if (isset($product['product_image']))
                                                <a class="item-img-wrapper-link"
                                                    ...
                                                    <img class="img-fluid"
                                                        src="{{ asset('front/product/image/large/' . $product['product_image']) }}"
                                                        alt="Product">
                                                </a>
                                            ...
                                            @else
                                                <a class="item-img-wrapper-link"
                                                    href="{{ url('/product/' . $product['id']) }}">
                                                    <img class="img-fluid"
                                                        src="{{ asset('front/images/product/product@2x.jpg') }}"
                                                        alt="Product">
                                                </a>
                                                <div class="item-action-behaviors">
                                                    <a class="item-quick-look" data-toggle="modal"
                ...
                <section class="section-maker">
                    <div class="container">
                        ...
                        <div class="slider-fouc">
                            <div class="products-slider owl-carousel" data-item="4">
                                @foreach ($recenltyViewproducts as $product)
                                    <div class="item">
                                        <div class="image-container">
                                            @if (isset($product['product_image']))
                                                <a class="item-img-wrapper-link"

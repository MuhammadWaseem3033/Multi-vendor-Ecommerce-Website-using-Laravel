        ...
        <div class="slider-main owl-carousel">
            <div class="bg-image">
                <div class="slide-content">
                    <h1><img src="{{ url('front/images/banners/banner-1.png') }}"></h1>
                    <h2>Spring Collection</h2>
                </div>
            </div>
            <div class="bg-image">
                <div class="slide-content">
                    <h1><img src="{{ url('front/images/banners/banner-2.png') }}"></h1>
        ...
        <div class="container">
            <div class="image-banner">
                <a target="_blank" rel="nofollow" href="#" class="mx-auto banner-hover effect-dark-opacity">
                    <img class="img-fluid" src="{{ url('front/images/banners/') }}" alt="Winter Season Banner">
                </a>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="item">
                                            <div class="image-container">
                                                <a class="item-img-wrapper-link" href="{{url('product',$product['id'])}}">
                                                    <img class="img-fluid"
                                                        src="{{ asset('front/product/image/small/' . $product['product_image']) }}"
                                                        alt="Product">
                                                </a>
                                    ...
                                    <div class="item">
                                        <div class="image-container">
                                            <a class="item-img-wrapper-link" href="single-product.html">
                                                <img class="img-fluid"
                                                    src="{{ url('front/images/product/product@3x.jpg') }}" alt="Product">
                                            </a>
                                            <div class="item-action-behaviors">
                                ...
                                <div class="products-slider owl-carousel" data-item="4">
                                    <div class="item">
                                        <div class="image-container">
                                            <a class="item-img-wrapper-link" href="single-product.html">
                                                <img class="img-fluid"
                                                    src="{{ url('front/images/product/product@3x.jpg') }}"
                                                    alt="Product">
                                            </a>
                                            <div class="item-action-behaviors">
                                                <a class="item-quick-look" data-toggle="modal" href="#quick-view">Quick
        ...
        <div class="container">
            <div class="image-banner">
                <a target="_blank" rel="nofollow" href="https://youtube.com/stackdevelopers"
                    ...
                    <img class="img-fluid" src="{{ url('front/images/banners/stack-develope') }}rs.png"
